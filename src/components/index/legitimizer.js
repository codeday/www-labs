...
export default () => (
  <Content marginTop={12} paddingTop={8} borderColor="green.500" backgroundColor="green.50" color="green.900" borderWidth={1} borderRadius="lg">
    <Heading paddingBottom={3} textAlign="center">The best summer option for aspiring programmers.</Heading>
    <Box fontSize="lg" paddingLeft={32} paddingRight={32}>
      <Text textAlign="center" paddingBottom={6}>
        ...
        <Button as="a" href="/apply" marginTop={4} variantColor="green" size="lg">Join us this summer.</Button>
      </Text>
    </Box>
  </Content>
);
