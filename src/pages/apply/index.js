          ...
          <Grid textAlign="center" templateColumns={{ base: '1fr', md: '1fr 1fr' }} gap={8}>
            <Box>
              ...
              <List textAlign="left" styleType="disc" stylePos="outside" pl={4} mb={8}>
                <Item mb={4}>
                  Your mentor will be an older student who has been an intern at a tech company.
                </Item>
                <Item mb={4}>
                ...
                <Item mb={4}>
                  You must have taken AP CS, or a college CS 1/101 course, or be able to demonstrate similar knowledge.
                  (If you have significant project-based experience, the intermediate track is a better fit.)
                </Item>
                <Item mb={4}>
                  There is a <Text as="span" mb={0} bold>$250 fee</Text> if accepted to confirm your spot, which helps
                  pay your mentor for the hands-on help they provide. If this is a barrier,{' '}
                  <Text as="span" mb={0} bold>many scholarships are available.</Text>
                </Item>
              </List>
            ...
            <Box>
              ...
              <List textAlign="left" styleType="disc" stylePos="outside" pl={4} mb={8}>
                ...
                <Item mb={4}>
                  Your mentor will provide guidance, but you'll need to work independently to debug many issues as they
                  come up.
                </Item>
                <Item mb={4}>
                  Intermediate track requires a college-level intro series and some project experience. Advanced track
                  requires upper-level college courses. We'll recommend a track after you apply.
                </Item>
                <Item mb={4}>
                  There is no fee to participate. This is not a paid internship, but you&apos;ll work on open-source
